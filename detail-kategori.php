...
$id = $_GET['id'];
$sql = "SELECT metadata_video.*, kategori_rekaman.kategori AS kategori 
            FROM metadata_video 
            LEFT JOIN kategori_rekaman ON metadata_video.kategori_rekaman_id = kategori_rekaman.id
            WHERE metadata_video.kategori_rekaman_id = $id";
                ...
                <table class="table table-info table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            echo "<tr><td colspan='10'>Tidak ada arsip metadata pada kategori</td></tr>";
                        }
                        ?>
                    </tbody>
