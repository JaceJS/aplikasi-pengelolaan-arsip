    ...
    <main class="container shadow p-4 rounded bg-light">
        ...
        <div class="table-responsive">
            <table class="table table-info table-striped" id="dataTable">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM lokasi_penyimpanan"; // Ambil 1 data dari tabel lokasi_penyimpanan dari phpmyadmin
                    $result = $mysqli->query($sql);

                    if ($result->num_rows > 0) { // Cek jika masih ada data di tabel lokasi_penyimpanan
                        $no = 1;
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <form action="proseshapusdata.php?id=<?php echo $row['id']; ?>" onsubmit="return confirm('Yakin ingin hapus <?php echo $row['lokasi']; ?>?');" method="POST">
        ...
        <?php include 'pop-up-tambahlokasi.php'; ?>
        <?php include 'pop-up-editlokasi.php'; ?>
